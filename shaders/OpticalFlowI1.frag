...
void main()
{
  ...
  vec2 c  = texture(PreviousVector, Blur3x3[4]).rg;
  vec2 ul = texture(PreviousVector, Blur3x3[0]).rg;
  vec2 u  = texture(PreviousVector, Blur3x3[1]).rg;
  vec2 ur = texture(PreviousVector, Blur3x3[2]).rg;
  vec2 l  = texture(PreviousVector, Blur3x3[3]).rg;
  vec2 r  = texture(PreviousVector, Blur3x3[5]).rg;
  vec2 bl = texture(PreviousVector, Blur3x3[6]).rg;
  vec2 b  = texture(PreviousVector, Blur3x3[7]).rg;
  vec2 br = texture(PreviousVector, Blur3x3[8]).rg;
